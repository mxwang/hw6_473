...
%type <nodePtr> Compound_Stmt Statements Statement Compound_Stmt_Function
...
int main1(int argc, char** argv){
   ...
   while (gettok() !=0) ; //gettok returns 0 on EOF
    ...
    initSymbolTable(); 	
    yyparse();
    if(typecheck()) //implemented in typecheck homework
		printf("typecheck returned true\n");
	//codegen(); //must be implemented in this homework.
